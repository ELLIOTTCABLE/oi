...
class AppDelegate < OSX::NSObject
  ...
  def applicationSupportFolder
    OSX.NSHomeDirectory.stringByAppendingPathComponent(File.join('Library', 'Application Support', 'oi'))
  end
  ...
  def managedObjectContext
    ...
    url = OSX::NSURL.fileURLWithPath(storeFolder.stringByAppendingPathComponent("oi.xml"))
